...
class Vehicle(Base):
    ...
    marchas = Column(Integer, nullable=True)
    motor_type = Column(String, nullable=True)
    cooling = Column(String, nullable=True)
    moto_style = Column(String, nullable=True)
    starter = Column(String, nullable=True)
    front_brake = Column(String, nullable=True)
    rear_brake = Column(String, nullable=True)
